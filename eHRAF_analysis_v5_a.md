# eHRAF OCM paragraph tagging — model v5 review sample
...
| OCM | Label | Predicted | Actual |
|---|---|---|---|
| 628 | INTER-COMMUNITY RELATIONS |  | x |
| 753 | THEORY OF DISEASE | x | x |
| 755 | MAGICAL AND MENTAL THERAPY | x |  |
| 756 | SHAMANS AND PSYCHOTHERAPISTS |  | x |
| 776 | SPIRITS AND GODS |  | x |

Hits: 1 of 4 actual codes predicted · False positives: 1.
...
Hits: 6 of 9 actual codes predicted · False positives: 2.
...
Hits: 3 of 4 actual codes predicted · False positives: 4.
...
| 614 | CLANS | x | x |
| 619 | TRIBE AND NATION | x |  |
| 627 | INFORMAL IN-GROUP JUSTICE | x |  |
...
Hits: 1 of 3 actual codes predicted · False positives: 0.
...
Hits: 1 of 5 actual codes predicted · False positives: 0.
...
Hits: 1 of 4 actual codes predicted · False positives: 0.
...
| 464 | LABOR SUPPLY AND EMPLOYMENT |  | x |
...
Hits: 2 of 3 actual codes predicted · False positives: 3.
...
Hits: 3 of 3 actual codes predicted · False positives: 3.
...
Hits: 1 of 2 actual codes predicted · False positives: 4.
...
Hits: 2 of 3 actual codes predicted · False positives: 4.
...
Hits: 0 of 3 actual codes predicted · False positives: 3.
...
Hits: 0 of 1 actual codes predicted · False positives: 1.
...
Hits: 4 of 4 actual codes predicted · False positives: 3.
...
Hits: 3 of 3 actual codes predicted · False positives: 4.
...
Hits: 3 of 5 actual codes predicted · False positives: 2.
...
| OCM | Label | Predicted | Actual |
|---|---|---|---|
| 182 | FUNCTIONAL/ADAPTATIONAL INTERPRETATIONS | x |  |
...
| 623 | COMMUNITY COUNCILS | x |  |
| 624 | LOCAL OFFICIALS | x |  |
| 701 | MILITARY ORGANIZATION | x |  |

Hits: 3 of 3 actual codes predicted · False positives: 5.
...
Hits: 4 of 5 actual codes predicted · False positives: 1.
...
| OCM | Label | Predicted | Actual |
|---|---|---|---|
| 177 | ACCULTURATION AND CULTURE CONTACT | x |  |
| 182 | FUNCTIONAL/ADAPTATIONAL INTERPRETATIONS | x | x |
| 430 | EXCHANGE AND TRANSFERS |  | x |
| 439 | EXTERNAL TRADE | x |  |
...
51 paragraphs across 10 sections (3–8 paragraphs, ≥3 distinct codes each, one section per document): precision 0.588, recall 0.638, F1 0.612, exact-set match 0.118.
